...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		var snowletter="tớ thích cậu lém"
		var sinkspeed=0.6
		var snowmaxsize=14
		var snowminsize=8
		var snowingzone=1
...
<br>
	<form>
		...
		<!--********** EDIT *****************-->
		<b>Chào Hồng yêu, Bạn có chút tình cảm gì với mình hong, chắc chắn là có òi phải hong nè</b>
		</span>
		</h2>
	...
	<br>
		...
		<!--********** EDIT *****************-->
<b><font color=#037500>Hí hí bạn hong chọn không dc đâu nha, thietj ra là có thích thì nói đại iii trời. hí hí</font>
</b>
</div></div>
    </li>
...
<tr><td colspan="3"><marquee onMouseOver="this.stop()" onMouseOut="this.start()" scrollamount="3" direction="left"><font color="#FF00FF">Tăng </font><font color="#FF00FF">Hồng yêu -- </font>
...
<p id="copy" onClick="window.open('https://www.facebook.com/TANTHUTHUATTINHOC','')">Liên hệ Tôi
</p>
<script>
var txt="---- Gởi Tặng Em -------------------------";
var espera=100;
